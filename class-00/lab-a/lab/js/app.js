...
function displayPics(){
  ...
  // TODO: When we changed the variable declaration from `var to `let` we changed it's scope, thus creating an error. The use of `let` created a blocked scope, only accessible inside the 'while' loop block. 
