...
// In this situation, "this" is the object constructor for Student (name, age, hometown).
// 2. What is "this" when joe.scopeArrow() is invoked?
// In this situation, "this" appears to be a parent Window.
// 3. Explain why "this" is different when an arrow function is used.
// Contextual "this" applies to object constructor functions that can be used globally. Arrow "this" applies locally only to the function it is used within.
